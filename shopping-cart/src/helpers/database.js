...
Database.createProduct({ images:image1Paths, name:'Jungle Gym Cat Tree 2.0', description:`Satisfy your cat’s natural instincts to scratch, perch, play, and catnap without sacrificing your home décor. The redesigned Jungle Gym Cat Tree 2.0 is an innovation in modern cat furniture, designed to accentuate and elevate your interior décor while providing your cat with a paradise of its very own.
...
So if you are looking for unique cat furniture with a modern twist, this affordable cat tree might be just up your alley. Because our Jungle Gym Cat Tree Condo is designed not only for your cat's comfort and entertainment but for yours as well. `, variants:[{type:'XL', stock:99, price:2}] })
